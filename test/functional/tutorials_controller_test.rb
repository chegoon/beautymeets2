...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { desc: @tutorial.desc, published: @tutorial.published, title: @tutorial.title, view_count: @tutorial.view_count, vimeo_url: @tutorial.vimeo_url }
    end
  ...
  test "should update tutorial" do
    put :update, id: @tutorial, tutorial: { desc: @tutorial.desc, published: @tutorial.published, title: @tutorial.title, view_count: @tutorial.view_count, vimeo_url: @tutorial.vimeo_url }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
