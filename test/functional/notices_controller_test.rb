...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { description: @notice.description, published: @notice.published, title: @notice.title, view_count: @notice.view_count }
    end
  ...
  test "should update notice" do
    put :update, id: @notice, notice: { description: @notice.description, published: @notice.published, title: @notice.title, view_count: @notice.view_count }
    assert_redirected_to notice_path(assigns(:notice))
  end
