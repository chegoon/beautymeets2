...
=end
	...
	def increment_page_view_count
		...
		if (controller_name != "sessions") && (controller_name != "registrations") && (controller_name != "authentications") && (controller_name != "passwords") && (controller_name != "info") && (session[:page_view_count] > 4 && !user_signed_in?)
