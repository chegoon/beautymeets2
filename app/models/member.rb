class Member < ActiveRecord::Base
  ...
  acts_as_taggable_on :skin_types, :skin_troubles, :skin_tones, :skin_brightnesses, :skin_colors

  attr_accessible :year_of_birth, :gender_id, :slug, :skin_type_list, :skin_trouble_list, :skin_tone_list, :skin_brightness_list, :skin_color_list
